...
import EntitiesUsers from '@users/infrastructure/database/typeorm'
import EntitiesUtils from '@utils/infrastructure/database/typeorm'
...
class DataBaseMysql {
    ...
    private constructor() {
        this.appDataSource = new DataSource({
            ...
            synchronize: false,
            logging: false,
            entities: { ...EntitiesUsers, ...EntitiesUtils },
            subscribers: [],
            migrations: [],
        })
    }
